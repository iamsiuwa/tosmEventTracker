...
export const maps = [
    ...
    { episode: 16, level: 130, name: '坦尼爾1世紀念區1', maxStages: 4, isStarred: false, respawnTime: 25 * 60 + 15, imagePath: `${BASE_URL}maps/XXXXXX.webp`, enName: 'Taniel I Commemorative Orb' },
    { episode: 16, level: 133, name: '緹玫勒斯寺院1', maxStages: 4, isStarred: false, respawnTime: 25 * 60 + 15, imagePath: `${BASE_URL}maps/XXXXXX.webp`, enName: 'Timerys Temple' }
];
